    ...
    programs.yazi = {
      ...
      in {
        manager = rec {
          ...
          tab_active = mkBoth base00 "#${config.lib.stylix.colors.${osConfig.desktopTheme.base16Accent}}";
        ...
        mode = {
          normal_main =
            (mkBoth base00 "#${config.lib.stylix.colors.${osConfig.desktopTheme.base16Accent}}")
            // {
              bold = true;
            };
          normal_alt = mkBoth "#${config.lib.stylix.colors.${osConfig.desktopTheme.base16Accent}}" base00;
          select_main =
            (mkBoth base00 green)
            // {
              bold = true;
        ...
        pick = {
          border = mkFg "#${config.lib.stylix.colors.${osConfig.desktopTheme.base16Accent}}";
          active = mkFg magenta;
        ...
        in [
          ...
          ((mkRule "inode/directory" "#${config.lib.stylix.colors.${osConfig.desktopTheme.base16Accent}}") // {bold = true;})
          (mkRule "*" base05)
        ];
      };
      settings = {
