    ...
    xdg = {
      mimeApps = rec {
        ...
        defaultApplications = {
          ...
          "text/x-markdown" = ["org.xfce.mousepad.desktop"]; # Any text files
          "text/x-tex" = ["org.xfce.mousepad.desktop"]; # Any text files
          "text/x-python" = ["org.xfce.mousepad.desktop"]; # Any text files
          "text/x-ruby" = ["org.xfce.mousepad.desktop"]; # Any text files
          "text/x-readme" = ["org.xfce.mousepad.desktop"]; # Any text files
          "text/x-java" = ["org.xfce.mousepad.desktop"]; # Any text files
          "application/x-shellscript" = ["org.xfce.mousepad.desktop"]; # Any text files
          "application/xml" = ["org.xfce.mousepad.desktop"]; # Any text files
          "inode/x-empty" = ["org.xfce.mousepad.desktop"]; # Any text files
