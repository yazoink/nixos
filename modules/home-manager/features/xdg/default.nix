    ...
    xdg = {
      mimeApps = rec {
        ...
        defaultApplications = {
          ...
          "video/ogg" = ["vlc.desktop"]; # Any video files
          "video/x-msvideo" = ["vlc.desktop"]; # Any video files
          "video/mpeg" = ["vlc.desktop"]; # Any video files
          "video/quicktime" = ["vlc.desktop"]; # Any video files
          "video/webm" = ["vlc.desktop"]; # Any video files
          "video/x-flv" = ["vlc.desktop"]; # Any video files
          "video/mp4" = ["vlc.desktop"]; # Any video files
          "audio/mp3" = ["vlc.desktop"]; # Any video files
          "audio/mp4" = ["vlc.desktop"]; # Any video files
          "audio/x-flac" = ["vlc.desktop"]; # Any video files
          "application/x-flash-video" = ["vlc.desktop"]; # Any video files
          "application/ogg" = ["vlc.desktop"]; # Any video files
